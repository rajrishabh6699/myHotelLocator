...
const MapContainer: React.FC = () => {
  ...
  const [selected, setSelected] = useState<SelectTypes | undefined>();
      ...
      <LoadScript
        ...
        >
          ...
          {selected
            ...
            selected.id
            &&
            <InfoWindow position={{ lat: Number(selected.lat), lng: Number(selected.lng) }} onCloseClick={() => setSelected(undefined)} options={{ pixelOffset: new window.google.maps.Size(0, -42) }}>
              <InfoDiv>
                <InfoImageDiv>
